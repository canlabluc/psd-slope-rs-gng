...
## March 19, 2017
#### refactor gng pipeline
Spent some time this afternoon refactoring and laying down the GNG data pipeline in order to be able to run it again on the fly in the future.

Part of this involved refactoring the MATLAB preprocessing scripts for GNG and RS data. Commit is [here](https://github.com/canlabluc/EEGLAB/commit/47463f3085122239e34fa1650d97b9c1b392e46f). This is now organized into three files:
- cl_preprocessingrs_sensorlevel.m
- cl_preprocessingrs_srcmodels.m
- cl_preprocessinggng.m
...
![rs_pvals_topo](.log-media/2017-03-18/rs-full-pvalues-topo-eyesc.png)

And the z-score differences between OAs and YAs:
![rs_zscores_topo](.log-media/2017-03-18/rs-full-zscores-diffs-eyesc.png)
...
![gng_zscores_topo](.log-media/2017-03-18/gng-zscores-diffs-eyesc.png)
...
![ya_PCC_comparison](.log-media/2017-03-13/ya_pcc_psd_halves.png)
...
![ya_DMN_comparison](.log-media/2017-03-13/ya_dmn_psd_halves.png)
...
![avg_def](.log-media/2017-03-11/avg_pcc_oa_ya_def.png)

And here are the average PSDs produced for the PCC, but cutting the YA trials back to 30 seconds.
![avg_mat](.log-media/2017-03-11/avg_pcc_oa_ya_match.png)
...
![pos_fit](.log-media/2017-03-10/s1121181262_bad_fit.png)
...
![old_psd](.log-media/2017-03-10/s1121181181_oldnewcomparison.png)
...
![jagged_psd](.log-media/2017-03-09/s1121181181_manual_psd.png)

The same channel, but simply passing all clean segments into sp.signal.welch and taking their average.
![avg_psd](.log-media/2017-03-09/s1121181181_avg_psd.png)

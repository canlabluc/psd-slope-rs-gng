...
subjoa = fit_slopes(subjoa, linreg_slope, 2, 45)
subjya = fit_slopes(subjya, linreg_slope, 2, 45)
...
df.to_csv('../data/pipeline-full/ya-oa-full-linreg-02-45.csv', index=False)
